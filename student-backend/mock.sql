...
VALUES
    ...
    ('67329238', 'Andrew', 'Tate', '20.05.1993', 'https://www.insidesport.in/wp-content/uploads/2023/03/1-2.png', 'male', 'poasjjsfaws', 'Bugatti47');
...
VALUES
    ...
    ('Sageneveien 32', '2024V', 'Oslo', 'Norway', 'true', '4', 'Loft rom, med flott utsikt til slottet!', 'false', 'true', '12345678', '6200', '13', 'https://entertromso.no/wp-content/uploads/2020/08/Apartments-with-two-bedrooms-bedroom-1024x683.jpg'),
    ('Mordigata 69', '2023V', 'Trondheim', 'Norway', 'true', '1', 'Flott roomate å bo med, midt i sentrum!', 'true', 'true', '12345678', '5700', '10', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3mG_TxkBgJdmcopPu0ICqEXPuOU8XQWsICg&usqp=CAU'),
    ('Brorgata 420', '2022H', 'Bergen', 'Norway', 'true', '5', 'Rett ved Grieghallen, gangavstand til alt du skulle ønske i Bergen sentrum!', 'true', 'false', '12345678', '5000', '15', 'https://www.bonava.no/siteassets/_inspiration/innredning/soverom/bonava-innredning-soverom-.jpg'),
    ('Faredinsvei 88', '2025V', 'Oslo', 'Norway', 'true', '7', 'Stort kollektiv, stort rom!', 'true', 'true', '12345678', '6400', '17', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2CVRALrUM5pHHfFrPViU-5Q4ag5Ck4kJ5zA&usqp=CAU'),
    ('Lord Amundsvei 1', '2024V', 'Trondheim', 'Norway', 'true', '2', 'Midt på Solsiden, flott beliggenhet', 'true', 'true', '12345678', '6000', '9', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQUiAK6I8Bs5-vNylTqKh5kus4hW0zuCIJ2A&usqp=CAU'),
    ('Dadddds 123', '2023V', 'Oslo', 'Norway', 'true', '3', 'Ballinciaga er dine roommates!!! gratis leie!!!', 'true', 'true', '12345678', '0', '20', 'https://images.squarespace-cdn.com/content/v1/622f95ddf8c6725b5213f9d5/7ca772ee-bcfa-4679-8a74-15121c80ee7f/Ballinciaga+Pressebilde+2+v2.jpg');
    ('Champ de Mars', '2024V', 'Paris', 'France', 'true', '2', 'le baguette', 'true', 'false', '29293828', '100', '220', 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1a/5b/4b/14/caption.jpg?w=1200&h=-1&s=1');
    ('1600 Pennsylvania Avenue NW', '2023V', 'Washington DC', 'USA', 'true', '31', 'Trump is not here', 'true', 'true', '31832082', '22', '1000', 'https://www.whitehouse.gov/wp-content/uploads/2021/01/white-house-sunrise.jpg');